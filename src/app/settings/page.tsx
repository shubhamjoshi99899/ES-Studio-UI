    ...
    <div className="max-w-4xl space-y-6 pb-12">
      <div className="border-b border-gray-100 pb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Manage your connected social accounts and workspace preferences.
        </p>
      </div>
        ...
        <div className="rounded-xl border border-blue-100 bg-blue-50 p-4 flex items-start gap-4 shadow-sm animate-in fade-in slide-in-from-top-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-blue-700 mt-1">
              We are currently downloading historical data for{" "}
              {syncStatus.pageCount} page(s). This happens in the background to
      ...
      {errorProfiles.length > 0 && (
        <div className="rounded-xl border border-red-200 bg-red-50 p-4 shadow-sm animate-in fade-in slide-in-from-top-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-bold text-red-900">
                Action Required: Facebook API Issues
              </h3>
              <p className="text-xs text-red-700 mt-1 mb-3">
                Facebook blocked us from fetching data for the following pages.
                This usually happens if Two-Factor Authentication (2FA) is
                required by the Page's Business Manager, or if you lack
              ...
              <div className="space-y-2 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                {errorProfiles.map((profile) => (
                  <div
                    ...
                    className="bg-white rounded border border-red-100 p-2.5 shadow-sm"
                  >
                    <span className="font-bold text-gray-900 text-xs block mb-0.5">
                      {profile.name}
                    </span>
                    <span className="text-xs text-red-600 font-mono bg-red-50 px-1.5 py-0.5 rounded break-words">
      ...
      <div>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white shadow-[0_2px_10px_rgba(0,0,0,0.02)] overflow-hidden">
          <div className="flex flex-col divide-y divide-gray-50">
            <div
              className={`p-6 transition-colors ${connected.meta ? "bg-blue-50/30" : "bg-white"}`}
            >
                ...
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div className="w-full max-w-lg">
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">
                      Publish posts, track engagement, and manage messages.
                    </p>
                ...
                {!connected.meta ? (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="rounded-xl border border-red-200 bg-white px-5 py-2 text-sm font-bold text-red-600 hover:bg-red-50 hover:border-red-300 shadow-sm transition-colors flex items-center gap-2"
                    >
                      Disconnect
                    </button>
                  </div>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">
                Securely log out of your Social Studio Analytics workspace.
              </p>
            </div>
            <button
              onClick={handleAppLogout}
              disabled={isLoggingOut}
              className="flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-5 py-2.5 text-sm font-bold text-gray-700 hover:bg-gray-50 hover:text-red-600 hover:border-red-200 shadow-sm transition-all disabled:opacity-50"
            >
              {isLoggingOut ? (
          ...
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
            <div className="p-6 border-b border-gray-100 bg-gray-50/50">
              ...
              <p className="text-sm text-gray-500 mt-2">
                Are you sure you want to disconnect? Your automated data syncing
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                <div className="mt-0.5">
                  <input
                    ...
                    onChange={(e) =>
                      setDeleteDataOnDisconnect(e.target.checked)
                    }
                    className="w-4 h-4 text-red-600 border-gray-300 rounded focus:ring-red-600 transition-colors cursor-pointer"
                  />
                </div>
                <div>
                  ...
                  <span className="text-xs text-gray-500 block mt-1 leading-relaxed">
                    Checking this will permanently remove all downloaded posts
                    and analytics from your database. Leave unchecked to save
                    time if you plan to reconnect later.
                  </span>
                </div>
              </label>
            </div>
            ...
            <div className="p-6 bg-gray-50 border-t border-gray-100 flex items-center justify-end gap-3 shrink-0">
              ...
              <button
                ...
                disabled={isDisconnecting}
                className="flex items-center gap-2 rounded-xl bg-red-600 px-6 py-2.5 text-sm font-bold text-white shadow-sm hover:bg-red-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isDisconnecting ? (
                  <Loader2 size={16} className="animate-spin" />
                ) : (
          ...
          <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden flex flex-col max-h-[85vh] animate-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between p-6 border-b border-gray-100 bg-gray-50/50">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Select the pages you want to track in your workspace.
                </p>
              </div>
              <button
            ...
            <div className="p-3 border-b border-gray-100 bg-white sticky top-0 z-10 space-y-3">
              ...
              <button
                ...
                className="flex items-center gap-2 w-full px-2 py-1 text-sm font-semibold text-gray-600 hover:text-blue-600 transition-colors"
              >
                ...
                filteredPages.map((page) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-4 w-full text-left px-4 py-3 text-sm transition-all rounded-xl border ${isSelected ? "bg-blue-50/50 border-blue-200 text-gray-900 shadow-sm" : "bg-white border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-200"}`}
                    >
                      {isSelected ? (
                        <CheckSquare
                          size={18}
                      ...
                      <span
                        className={`truncate flex-1 ${isSelected ? "font-bold" : "font-medium"}`}
                      >
                        {page.name}
                      </span>
                    </button>
            ...
            <div className="p-6 bg-white border-t border-gray-100 flex items-center justify-between shrink-0">
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-xl bg-[#1877F2] px-6 py-2.5 text-sm font-bold text-white shadow-sm hover:bg-[#166fe5] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
                  <Loader2 size={16} className="animate-spin" />
                ) : (
